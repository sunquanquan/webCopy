...
MPT.Config.poster = {
    gamePrivilege: MPT.Config.iwgame_http + "/js/32.js",
    gameInfo: MPT.Config.iwgame_http + "/js/34.js",
    downloadInfo: MPT.Config.iwgame_http + "/js/35.js",
    recentActivity: MPT.Config.iwgame_http + "/js/36.js",
    productPoster: MPT.Config.iwgame_sslres + "/js/49.js",
    passportLoginBg: MPT.Config.iwgame_sslres + "/js/50.js"
};
MPT.Config.req = {
...
MPT.Config.url = {
    ...
    pLoginPage: MPT.Config.passport_http +'/ploginpage',
    ...
    cs_findpw: MPT.Config.cs_http + "/findPw?cur=mobile&pid=" + MPT.pid,
    ...
    cs_getbackacc: MPT.Config.cs_http + "/getbackacc?pid=" + MPT.pid,
