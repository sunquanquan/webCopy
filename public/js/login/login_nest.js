            ...
            switch (b.errorCode) {
                ...
                case MPT.Config.result["captchaExpired"][0]:
                    if (_isTwoCaptcha) {
                        ...
                        getNewCaptcha(e.parent().siblings().get(0), _xct)
                    } else {
    ...
    $(".e_login_form").attr("action", MPT.Config.req["login"]).Validform({
        ...
        datatype: {
            ...
            captcha: function () {
                ...
                return MPT.Config.regular["captcha"].test(b.val())
            }
        },
...
MPT.addAction("login_pop", function () {
    ...
    $(".e_login_pop_other a").eq(0).click(function () {
        Utils.openTargetView(MPT.Config.url["cs_findpw"])
    });
    $(".e_login_pop_other a").eq(1).click(function () {
        Utils.openTargetView(MPT.Config.url["cs_getbackacc"])
    });
    ...
    $(".e_login_pop_other a").eq(3).click(function () {
        Utils.openTargetView(MPT.Config.url["cs_faq"])
    })
});
function showCapt(a) {
...
function loginCaptcha2() {
    ...
    popup(a, {width: 392}, function () {
        ...
        b.focus(function () {
            ...
            if (!h) {
                getNewCaptcha(g.parent().siblings().get(0), _xct)
            }
        });
        d.Validform({
