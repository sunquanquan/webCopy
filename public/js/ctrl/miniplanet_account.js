...
MPT.Config['lib_list'] = ['jquery.min.js', 'jquery.blockUI.min.js', 'Validform.min.js', 'passwordStrength-min.js'];
MPT.Config['tpl_list'] = ['tpl_public.js','tpl_leftnav.js', 'tpl_account.js'];
MPT.Config['ctrl_list'] = ['config.js', 'util.js', 'public.js', 'account.js'];
