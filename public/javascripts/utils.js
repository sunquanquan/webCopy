var Utils = {
    isIe: !!window.ActiveXObject || "ActiveXObject" in window, isPlaceholder: "placeholder" in document.createElement("input"), initPlaceholder: function (d, c, a) {
        ...
        if (!MPT.Config.regular["password"].test(d)) {
            return 0
        }
