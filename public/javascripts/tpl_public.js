MPT.addTmpl("t_public_top", function (e) {
    ...
    if (e.accountName) {
        ...
        c.push('		<li class="fl"><a href="' + MPT.Config.url["space"]["logout"] + '" class="block public-top-account-logout">退出</a></li>');
        c.push("	</ul>")
    } else {
    ...
    c.push('			<li class="fl"><a href="javascript:;" class="block" >设为首页</a></li>');
/*
    c.push('			<li class="fl"><a href="javascript:;" class="block" onclick="Utils.setHome(this,\'' + location.href + "');\">设为首页</a></li>");
*/
    c.push('			<li class="fl">');
    c.push('				<a href="javascript:;" class="block"><i class="fr"></i>初度游戏</a>');
    ...
    if (e.accountName) {
        ...
        c.push('				<h2><a href="' + MPT.Config.url["space"]["center_pw"] + '">密码修改</a></h2>');
        c.push('				<h2><a href="' + MPT.Config.url["space"]["center_mobile"] + '">安全手机</a></h2>')
    } else {
        c.push('				<h2><a href="' + MPT.Config.url["cs_findpw"] + '" target="_blank">密码找回</a></h2>')
    }
    c.push("				</div>");
    ...
    c.push('				<div class="hide public-top-menu-options">');
    c.push('					<i class="public-pic"></i>');
    c.push('					<h2><a href="' + MPT.Config.url["pay"] + '" target="_blank">充值</a></h2>');
...
MPT.addTmpl("t_public_header", function (c) {
    ...
    b.push('		<h1><a href="' + MPT.Config.url["iwgame"] + '" class="fl public-pic1 public-header-logo" target="_blank" title="绿岸在线"></a></h1>');
    b.push('		<ul class="fr public-header-nav">');
    if (c.cur == "我的通行证") {
        b.push('		<li class="fl cur"><a href="' + MPT.Config.url["space"]["passport"] + '">我的通行证</a></li>')
    } else {
        b.push('		<li class="fl"><a href="' + MPT.Config.url["space"]["passport"] + '">我的通行证</a></li>')
    }
    if (c.cur == "账号中心") {
        b.push('		<li class="fl cur"><a href="' + MPT.Config.url["space"]["center"] + '">账号中心</a></li>')
    } else {
        b.push('		<li class="fl"><a href="' + MPT.Config.url["space"]["center"] + '">账号中心</a></li>')
    }
    if (c.cur == "充值中心") {
        b.push('		<li class="fl cur"><a href="' + MPT.Config.url["pay"] + '" target="_blank">充值中心</a></li>')
    } else {
        b.push('		<li class="fl"><a href="' + MPT.Config.url["pay"] + '" target="_blank">充值中心</a></li>')
    }
    if (c.cur == "客服中心") {
...
MPT.addTmpl("t_public_footer", function () {
    ...
    b.push('			<li class="fl"><a href="' + MPT.Config.url["iwgame"] + '" class="block public-pic1 public-footer-logo" target="_blank" title="初度网络"></a></li>');
